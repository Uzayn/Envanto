  ...
  return (
    <section>
      ...
      <div className={`${styles.paddingY} flex justify-center`}>
        ...
        <div className='font-Lato font-normal text-[24px] leading-[21px] w-full md:w-fit ml-[20px] overflow-hidden'>
          <div className='md:flex'>
            <div className='font-Lato font-normal text-dimBlack text-[14px] md:text-[24px] leading-[21px]'>Name</div>
            <div>
              <input type="text" className='border border-grey rounded bg-transparent w-full md:w-[505px] h-[40px] md:h-[60px] md:ml-[42px] mb-[16px] md:mb-[40px]' />
            </div>
          </div>
          <div className='md:flex'>
            <div className='font-Lato font-normal text-dimBlack text-[14px] md:text-[24px] leading-[21px]'>Email</div>
            <div>
              <input type="text" className='border border-grey rounded bg-transparent w-full md:w-[505px] h-[40px] md:h-[60px] md:ml-[47px] mb-[16px] md:mb-[40px]' />
            </div>
          </div>
          <div className='md:flex'>
            <div className='font-Lato font-normal text-dimBlack text-[14px] md:text-[24px] leading-[21px]'>Subject</div>
            <div>
              <input type="text" className='border border-grey rounded bg-transparent w-full md:w-[505px] h-[40px] md:h-[60px] md:ml-[27px] mb-[16px] md:mb-[40px]' />
            </div>
          </div>
          <div className='md:flex'>
            <div className='font-Lato font-normal text-dimBlack text-[14px] md:text-[24px] leading-[21px]'>Message</div>
            <div>
              <input type="text" className='border border-grey rounded bg-transparent w-full md:w-[505px] h-[141px] md:h-[228px] md:ml-[12px] mb-[16px] md:mb-[71px]' />
            </div>
          </div>
